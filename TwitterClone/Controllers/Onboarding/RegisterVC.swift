...
//  TwitterClone
//
//  Created by Haytham on 05/08/2023.
//
...
//            print(user)
    ...
    private func configureConstrants() {
        ...
        let registerTitleLabelConstrants = [
        ...
        NSLayoutConstraint.activate(registerTitleLabelConstrants)
        NSLayoutConstraint.activate(emailTextFieldConstrants)
        NSLayoutConstraint.activate(passwordTextFieldConstrants)
        NSLayoutConstraint.activate(registerButtonConstrants)
